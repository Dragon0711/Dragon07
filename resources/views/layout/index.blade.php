            ...
            <div class="deals_slider_container">
                ...
                <div class="owl-carousel owl-theme deals_slider">
                    ...
                    <div class="owl-item deals_item">
                        <div class="deals_image"><img src="{{ asset("upload/product/$deal->image_1")}}" alt=""></div>
                        <div class="deals_content">
                            <div class="deals_info_line d-flex flex-row justify-content-start">
                                <div class="deals_item_category"><a href="#">{{ $deal->brand_name }}</a></div>
                                @if($deal->discount_price == null)
                                @else
                                <div class="deals_item_price_a ml-auto">{{$deal->price}}$</div>
                                @endif
                            </div>
                            <div class="deals_info_line d-flex flex-row justify-content-start">
                            ...
                            <div class="available">
                                <div class="available_line d-flex flex-row justify-content-start">
                                    <div class="available_title">Available: <span>{{ $deal->quantity }}</span></div>
            ...
            <div class="tabbed_container">
                    ...
                    @foreach($featured as $row )
                        ...
                        <div class="featured_slider_item">
                            ...
                            <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                <div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="{{ asset("upload/product/$row->image_1")}}" style="height:120px; width:100px" alt=""></div>
                ...
                <div class="product_panel panel">
                    <div class="featured_slider slider">
                        ...
                        @foreach($trend as $rowT)
                        <!-- Slider Item -->
                        <div class="featured_slider_item">
                            <div class="border_active"></div>
                            <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                <div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="{{ asset("upload/product/$rowT->image_1")}}" style="height: 120px; width: 100px" alt=""></div>
                                <div class="product_content">
                                    @if($rowT->discount_price == null)
                                    <div class="product_price discount">{{ $rowT->price }}$</div>
                                    @else
                                ...
                                <a href="{{URL('add/wishlist/'.$rowT->id)}}">
                                    <div class="product_fav"><i class="fas fa-heart"></i></div>
                                </a>
                                <ul class="product_marks">
                                    @if($rowT->discount_price == null)
                                    ...
                                    @else
                                        <li class="product_mark product_discount">
                                            @php
                                                $mount = $rowT->price - $rowT->discount_price;
                                                $discount = $mount/$rowT->price*100;
                                            @endphp
                                            {{intval($discount)}}%
                                        </li>
                                    @endif
                       ...
                       @foreach($products as $product)
                        ...
                        <div class="owl-item">
                            <div class="popular_category d-flex flex-column align-items-center justify-content-center">
                                ...
                                <div class="popular_category_text">{{ $product->categoryT->name }}</div>
                            </div>
                        </div>
                           @endforeach
                    </div>
                        ...
                        <div class="row fill_height">
                            <div class="col-lg-4 col-md-6 fill_height">
                                <div class="banner_2_content">
                                    <div class="banner_2_category"><h6>{{$slider->brand_name}}</h6></div>
                                    <div class="banner_2_title">{{$slider->name}}</div>
                                    <div class="banner_2_text"><h5>{{ $slider->price }}$</h5></div>
                            ...
                            <div class="col-lg-8 col-md-6 fill_height">
                                <div class="banner_2_image_container">
                                    <div class="banner_2_image"><img src="{{ asset("upload/product/$slider->image_1")}}" alt=""></div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col">
                <div class="tabbed_container">
                    <div class="tabs clearfix tabs-right">
                        <div class="new_arrivals_title">{{$watchs->name}}</div>
                        <ul class="clearfix">
                            <li class="active"> </li>
                        </ul>
                        <div class="tabs_line"><span></span></div>
    ...
    <div class="container">
        <div class="row">
            <div class="col">
                <div class="tabbed_container">
                    <div class="tabs clearfix tabs-right">
                        <div class="new_arrivals_title">{{ $mensFashoin->name }}</div>
                        <ul class="clearfix">
                            <li class="active"> </li>
                        </ul>
                        <div class="tabs_line"><span></span></div>
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                <div class="trends_container">
                    ...
                    <div class="trends_text"><p>Buy one and Get one free disscount for short time.</p></div>
                    ...
                    <div class="owl-carousel owl-theme trends_slider">
                        ...
                        <div class="owl-item">
                            <div class="trends_item is_new">
                                <div class="trends_image d-flex flex-column align-items-center justify-content-center"><img src="{{ asset("upload/product/$row->image_1")}}" alt=""></div>
            ...
            <div class="col">
                <div class="newsletter_container d-flex flex-lg-row flex-column align-items-lg-center align-items-center justify-content-lg-start justify-content-center">
                    ...
                    <div class="newsletter_content clearfix">
                        <form action="{{ url('add/newslater') }}" method="POST" class="newsletter_form">
                            @csrf
